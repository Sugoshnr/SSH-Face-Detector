...
def DetectionModel(model, name, detection_conv_name, context_conv_name):
	...
	classScores = Conv2D(2, (1,1), padding='same', name=detection_conv_name[2])(detection_model)
	#classScores = Conv2D(4, (1,1), padding='same', name=detection_conv_name[2])(detection_model)
	regressorScores = Conv2D(8, (1,1), padding='same', name=detection_conv_name[3])(detection_model)
...
M1_dimReduction_2 = Cropping2D(cropping=((0, 84), (0, 84)))(M1_dimReduction_2)
...
print ('DetectionModulelM1: ', DetectionModulelM1[0].shape, DetectionModulelM1[0][3])
